...
<html lang="en" dir="ltr">
  ...
  This script creates the table 'class_participation_commission_all'
  ...
  <body>
    ...
    ?>
		<div class="container" style="background-color: #e9ecef;">
			...
			<div class="row">
				<div class="col-4">
					<a class="btn btn-outline-primary" href="./code_vote_9_class_participation.php" role="button">Back</a>
				</div>
				<div class="col-4">
					<a class="btn btn-outline-secondary" href="http://<?php echo $_SERVER['SERVER_NAME']. ''.$_SERVER['REQUEST_URI'] ?>" role="button">Refresh</a>
				</div>
				<div class="col-4">
					<a class="btn btn-outline-success" href="./votes_12.php" role="button">NEXT</a>
				</div>
			</div>
			<div class="row mt-3">
        <div class="col-12">
        ...
        // CONNEXION SQL //
          ...
          $bdd->query('
            DROP TABLE IF EXISTS class_participation_commission_all;
            CREATE TABLE class_participation_commission_all
              ...
              PRIMARY KEY (id));
              ALTER TABLE class_participation_commission_all ADD INDEX idx_mpId (mpId);
          ');
          ...
          while ($depute = $result->fetch()) {
            ...
            $sql = $bdd->prepare("INSERT INTO class_participation_commission_all (classement, mpId, score, votesN, dateMaj) VALUES (:classement, :mpId, :score, :votesN, :dateMaj)");
