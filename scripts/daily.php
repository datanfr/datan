...
class Script
{
    ...
    public function deputeLast()
    {
        ...
        $this->bdd->exec('ALTER TABLE deputes_last CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;');
    }
    ...
    public function groupeStats()
    {
        ...
        $this->bdd->query('CREATE TABLE groupes_stats ( organeRef VARCHAR(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , womenPct DECIMAL(4,2) NULL , womenN INT(3) NULL  , age DECIMAL(4,2) NULL, rose_index DECIMAL(4,3) ) ENGINE = InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;');
    ...
    public function groupeStatsHistory(){
      ...
      $this->bdd->query('CREATE TABLE IF NOT EXISTS `groupes_stats_history`(
        `organeRef` VARCHAR(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL ,
        `stat` VARCHAR(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL ,
    ...
    public function groupeAccord()
    {
        ...
        $this->bdd->query('
            CREATE TABLE IF NOT EXISTS groupes_accord (
                ...
                organeRef VARCHAR(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL,
                organeRefAccord VARCHAR(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL,
    ...
    public function classParticipation()
    {
        ...
        $this->bdd->query('ALTER TABLE class_participation CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ');
    }
    ...
    public function classGroupsProximite()
    {
        ...
        $this->bdd->query("ALTER TABLE class_groups_proximite CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ");
    }
    ...
    public function dossiersSeances(){
        ...
        $this->bdd->query('CREATE TABLE IF NOT EXISTS `dossiers_seances` (
            ...
            `dossierId` VARCHAR(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NULL DEFAULT NULL ,
            `legislature` INT NULL DEFAULT NULL ,
            `seanceId` VARCHAR(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NULL DEFAULT NULL ,
        ...
        if ($zip->open($file) !== TRUE) {
            ...
            for ($i = 0; $i < $zip->numFiles; $i++) {
                ...
                if ($xml_string != false) {
                  ...
                  $id = $xml->uid;
                  $legislature = $xml->legislature;
                  $examined_by = $xml->identification->prefixeOrganeExamen;
    ...
    public function historyMpsAverage()
    {
        ...
        $this->bdd->query('CREATE TABLE `history_mps_average` ( `id` TINYINT NOT NULL AUTO_INCREMENT , `legislature` TINYINT NOT NULL , `length` DECIMAL(4,2) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;');
    ...
    public function debatsInfos(){
        ...
        $this->bdd->query("CREATE TABLE IF NOT EXISTS `debats_infos` (
            `uid` VARCHAR(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL,
            `seanceRef` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  DEFAULT NULL,
            `sessionRef` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  DEFAULT NULL,
            `dateSeance` DATE DEFAULT NULL,
            `numSeanceJour` INT DEFAULT NULL,
            `legislature` INT DEFAULT NULL,
            `dateMaj` DATE DEFAULT NULL,
            PRIMARY KEY (`uid`)
        ) ENGINE = MyISA CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;");
    ...
    public function parrainages(){
      ...
      $this->bdd->query("CREATE TABLE IF NOT EXISTS `parrainages` (
          ...
          `circo` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NULL DEFAULT NULL ,
          ...
          INDEX `mpId_idx` (`mpId`)) ENGINE = InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
      ");
