...
EXPORT_TABLES($_SERVER['DATABASE_HOST'], $_SERVER['DATABASE_USERNAME'], $_SERVER['DATABASE_PASSWORD'], $_SERVER['DATABASE_NAME'], array("newsletter"));
...
function EXPORT_TABLES($host, $user, $pass, $name, $tables = false, $backup_name = false)
{
    ...
    $date = date("Y-m-d");
    $file = $_SERVER['ABSOLUTE_PATH'] . '/scripts/update_dataset/backup/newsletter/' . date("Ymd") .'.sql';

    if(!is_file($file)){
      file_put_contents($file, "");

      $contentFinal = " /* DATABASE BACKUP FOR THE newsletter TABLE \n";
