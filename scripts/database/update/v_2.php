<?php
  ...
  */
  ...
  if ($new_v > $last_v_installed) {
    ...
    /* 2. MAKE YOUR CHANGE TO THE DATABASE */
    $prepare = $bdd->prepare("ALTER TABLE `explications_mp` ADD `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER `state`, ADD `modified_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER `created_at`");
