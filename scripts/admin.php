            ...
            <div class="col">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="card-subtitle text-muted">November 27, 2021</h6>
                  <p class="card-text">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="card-subtitle text-muted">November 26, 2021</h6>
                  <p class="card-text">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Update database : new table with electoral results</h5>
                  <h6 class="card-subtitle text-muted">November 25, 2021</h6>
                  <p class="card-text">
