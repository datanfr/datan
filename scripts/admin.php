            ...
            <div class="col">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <a class="btn btn-danger my-3" href="update_dataset/20220620_add_legislatives_url.php" role="button">UPDATE DATABASE</a>
                  </p>
                </div>
              </div>
              <hr>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Create new field in quizz table: swap
                    <a class="btn btn-danger my-3" href="update_dataset/20220525_quizz.php" role="button">UPDATE DATABASE</a>
                  </p>
                </div>
              </div>
              <hr>
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Update database : New table: 'password_resets'</h5>
                  <h6 class="card-subtitle text-muted">April 11, 2022</h6>
                  <p class="card-text">
                    <a class="btn btn-danger my-3" href="update_dataset/20220411_password_resets.php" role="button">UPDATE DATABASE</a>
                  </p>
                </div>
              </div>
              <hr>
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    <a class="btn btn-danger my-3" href="update_dataset/20220204_indexes.php" role="button">UPDATE DATABASE</a>
                  </p>
                </div>
              </div>
              <hr>
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="card-subtitle text-muted">January 28, 2022</h6>
                  <p class="card-text">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="card-subtitle text-muted">January 27, 2022</h6>
                  <p class="card-text">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="card-subtitle text-muted">January 26, 2022</h6>
                  <p class="card-text">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Update database : new table with electoral results</h5>
                  <h6 class="card-subtitle text-muted">January 25, 2022</h6>
                  <p class="card-text">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Update database : dossiersActeurs</h5>
                  <h6 class="card-subtitle text-muted">October 17, 2021</h6>
                  <p class="card-text">
                    Add new table (dossiersActeurs)
                    <a class="btn btn-danger my-3" href="update_dataset/20211017_dossiersActeurs.php" role="button">UPDATE DATABASE</a>
                  </p>
                </div>
              </div>
              <br>
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Update database : hatvp</h5>
                  <h6 class="card-subtitle text-muted">October 03, 2021</h6>
                  <p class="card-text">
                    Add new column (hatvp) in deputes table
                    <a class="btn btn-danger my-3" href="update_dataset/20211003_hatvp.php" role="button">UPDATE DATABASE</a>
                  </p>
                </div>
              </div>
              <br>
