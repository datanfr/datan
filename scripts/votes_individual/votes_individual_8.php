  ...
  <body>
        ...
        // CONNEXION SQL //
          ...
          if (isset($_GET["vote"])) {
            ...
            //DELETE FROM TABLE
            $sql_delete = "DELETE FROM deputes_accord WHERE num = :number_to_get";
        ...
        $i = 1;
        $groupes = ["PO730964", "PO730934", "PO730970", "PO730952", "PO730946", "PO723569", "PO730958", "PO730940", "PO744425", "PO758835", "PO759900", "PO765636", "PO767217", "PO771789", "PO771889", "PO771923"];
