<?php
  ...
  // Create table amendements_auteurs
  $bdd->query('DROP TABLE IF EXISTS `documents_legislatifs`');
  $bdd->query("CREATE TABLE `documents_legislatifs` (
    `id` VARCHAR(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
    `dossierId` VARCHAR(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
    `numNotice` INT(10) NULL DEFAULT NULL ,
    `titre` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
    `titreCourt` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
    `dateMaj` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
  ) ENGINE = MyISAM;");
