...
// Iframe
$route['iframe/depute'] = 'iframe/depute';
$route['iframe/depute/(:any)/(:any)'] = 'IframeController/showDeputeIframe/$1/$2';
// COMMISSION
...
$route['deputes/(:any)/depute_(:any)/votes'] = 'deputes/votes/$2/$1';
