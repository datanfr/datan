  ...
  class Votes extends CI_Controller {
    ...
    public function individual($legislature, $num, $congress = FALSE, $explication = FALSE){
      ...
      if ($explication) {
        ...
        $data['explication']['photoSquare'] = $this->deputes_model->get_photo_square($data['explication']['legislature']);
        if (!$data['explication']) {
      ...
      $this->load->view('templates/breadcrumb', $data);
      //$this->load->view('votes/modals/vote_datan_requested', $data); Has been removed
      $this->load->view('templates/footer');
