                  ...
                  <div class="mt-4 p-4" style="background-color: rgba(0, 183, 148, 0.3)">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        ...
                        <p>Le lien vers le site de campagne permet de mettre, dans le bloc consacré aux élections sur votre page personnelle, un bouton vers votre site de campagne.</p>
                        <p>Ce lien peut diriger vers votre site internet, votre page Facebook ou Twitter, ou vers un document de campagne.</p>
                      </div>
                      <div class="col-md-8">
