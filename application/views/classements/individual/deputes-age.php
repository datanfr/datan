      ...
      <div class="row row-grid mt-5">
        <div class="col-md-6 py-3">
          ...
          <div class="card card-depute">
            ...
            <div class="card-avatar">
              <img class="img-lazy" src="<?= asset_url() ?>imgs/placeholder/placeholder-face.png" data-src="<?= base_url(); ?>assets/imgs/deputes/depute_<?= substr($mpOldest["mpId"], 2) ?>.png" alt="<?= $mpOldest['nameFirst'].' '.$mpOldest['nameLast'] ?>">
            </div>
        ...
        <div class="col-md-6 py-3">
          ...
          <div class="card card-depute">
            ...
            <div class="card-avatar">
              <img class="img-lazy" src="<?= asset_url() ?>imgs/placeholder/placeholder-face.png" data-src="<?= base_url(); ?>assets/imgs/deputes/depute_<?= substr($mpYoungest["mpId"], 2) ?>.png" alt="<?= $mpYoungest['nameFirst'].' '.$mpYoungest['nameLast'] ?>">
            </div>
            <div class="card-body d-flex align-items-center justify-content-center">
              <div>
                <span class="d-block card-title">
