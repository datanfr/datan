      ...
      <div class="row row-grid mt-5">
        <div class="col-md-6 py-3">
          ...
          <div class="d-flex justify-content-center">
            <?php $this->load->view('deputes/partials/card_home.php', array('depute' => $mpOldest, 'tag' => 'span', 'stat' => $mpOldest['age'] . " ans", 'footer' => 'discover', 'logo' => true)) ?>
          </div>
        </div>
        <div class="col-md-6 py-3">
          <h2 class="text-center"><?= ucfirst($mpYoungestGender['le']) ?> <?= $mpYoungestGender['depute'] ?> <?= $mpYoungestGender["le"] ?> plus jeune</h2>
          <div class="d-flex justify-content-center">
            <?php $this->load->view('deputes/partials/card_home.php', array('depute' => $mpYoungest, 'tag' => 'span', 'stat' => $mpYoungest['age'] . " ans", 'footer' => 'discover', 'logo' => true)) ?>
          </div>
        </div>
      </div>
      <div class="mt-5">
