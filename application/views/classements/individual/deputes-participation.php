      <div class="row mt-4">
        <div class="col-md-10">
          ...
          <?php if ($mps): ?>
            ...
            <p><b>Nous proposons donc trois scores de participation :</b></p>
            <p>Le <u>premier</u> ne concerne que les votes solennels. Les votes solennels sont les votes les plus importants et concernent des projets de loi significatifs et fortement discutés dans les médias. Pour ces votes, le jour et l'heure du vote sont connus à l'avance, favorisant ainsi la présence des parlementaires dans l'hémicycle. Le taux de participation moyen pour ce score est de <?= $participationSolennelsMean ?> %.</p>
