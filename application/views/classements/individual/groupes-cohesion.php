      <div class="row mt-4">
        <div class="col-md-10">
          ...
          <?php if ($groups): ?>
            <p>
              Le groupe parlementaire qui affiche la plus grande cohésion est <a href="<?= base_url() ?>groupes/legislature-<?= $groupsFirst["legislature"] ?>/<?= mb_strtolower($groupsFirst["libelleAbrev"]) ?>"><?= name_group($groupsFirst["libelle"]) ?></a> (<?= $groupsFirst["libelleAbrev"] ?>), avec un taux de cohésion de <b><?= round($groupsFirst['cohesion'], 2) ?></b>.
      ...
      <?php if ($groups): ?>
        <div class="row row-grid mt-5">
          <div class="col-md-6 py-3">
            ...
            <?php $this->load->view('groupes/partials/card_home.php', array('groupe' => $groupsFirst, 'tag' => 'span', 'active' => TRUE, 'stats' => "Cohésion : " . round($groupsFirst["cohesion"], 2), 'cat' => false)) ?>
          </div>
          <div class="col-md-6 py-3">
            <h2 class="text-center">Le plus divisé</h2>
            <?php $this->load->view('groupes/partials/card_home.php', array('groupe' => $groupsLast, 'tag' => 'span', 'active' => TRUE, 'stats' => "Cohésion : " . round($groupsLast["cohesion"], 2), 'cat' => false)) ?>
          </div>
        </div>
        <div class="mt-5">
