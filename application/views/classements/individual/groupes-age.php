      <div class="row mt-4">
        <div class="col-md-10">
          ...
          <?php if ($groupsAge): ?>
            <p>Le groupe parlementaire avec la moyenne d'âge la plus élevée est <a href="<?= base_url() ?>groupes/legislature-<?= $groupOldest["legislature"] ?>/<?= mb_strtolower($groupOldest["libelleAbrev"]) ?>"><?= $groupOldest["libelle"] ?></a>. Ses membres ont en moyenne <?= $groupOldest["age"] ?> ans.</p>
            <p>Le groupe <a href="<?= base_url() ?>groupes/legislature-<?= $groupYoungest["legislature"] ?>/<?= mb_strtolower($groupYoungest["libelleAbrev"]) ?>"><?= $groupYoungest["libelle"] ?></a> est celui avec la moyenne d'âge la plus faible. En effet, les députés membres du groupe <?= $groupYoungest["libelleAbrev"] ?> ont en moyenne <?= $groupYoungest["age"] ?> ans.</p>
          <?php endif; ?>
      ...
      <?php endif; ?>
      <?php if ($groupsAge): ?>
        <div class="row row-grid mt-5 test-border">
