    <div class="container pg-stats-index mb-5">
      <div class="row bloc-titre">
        ...
        <div class="col-md-4 offset-lg-1 d-none d-md-flex align-items-start">
          <div class="p-4">
            <?= file_get_contents(FCPATH . "assets/imgs/svg/undraw_visual_data_b1wx_2.svg") ?>
          </div>
        </div>
      </div>
      <!-- AGE -->
      <div class="row">
        <div class="col-12">
          <div class="title_svg">
            ...
            <?= file_get_contents(FCPATH ."assets/imgs/svg/blob_1.svg") ?>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-5 ">
        <div class="col-12">
          <div class="title_svg">
            ...
            <?= file_get_contents(FCPATH ."assets/imgs/svg/blob_2.svg") ?>
          </div>
        </div>
      </div>
      <div class="row bloc-ranking mt-5">
      ...
      <div class="row mt-5 ">
        <div class="col-12">
          <div class="title_svg">
            ...
            <?= file_get_contents(FCPATH ."assets/imgs/svg/blob_3.svg") ?>
          </div>
        </div>
      </div>
      <div class="row bloc-ranking mt-5">
      ...
      <div class="row mt-5 ">
        <div class="col-12">
          <div class="title_svg">
            ...
            <?= file_get_contents(FCPATH ."assets/imgs/svg/blob_4.svg") ?>
          </div>
        </div>
      </div>
      <div class="row bloc-ranking mt-5">
