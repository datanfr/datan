    ...
    <div class="row">
      ...
      <div class="col-md-10 col-lg-8 offset-md-1 offset-lg-0 pl-lg-5">
        ...
        <div class="bloc-bio mt-5">
          ...
          <p>
            <?= ucfirst($gender['pronom']) ?> est entré<?= $gender['e'] ?>
            <?php if (!isset($mandats_legislature["current"])): ?>
               en fonction en <?= $mandats_legislature['fonction_lettres'] ?> et en <?= $active == TRUE ? 'est' : 'était' ?> à son <?= $mandat_edito ?> mandat.
              <?php else: ?>
              initiallement en fonction en <?= $mandats_legislature['last']['fonction_lettres'] ?>
              <?php if ($mandats_legislature["current"]["reason"] == "invalidation"): ?>
                mais a vu son élection invalidée. <?= ucfirst($gender['pronom']) ?> a été réélu<?= $gender['e'] ?> en <?= $mandats_legislature['current']['election_lettres'] ?>.</p><p>
              <?php elseif ($mandats_legislature['current']['reason'] == 'gvt'): ?>
                mais a quitté l'Assemblée nationale pour devenir ministre. Ayant depuis quitté le gouvernement, il est redevenu député en <?= $mandats_legislature['current']['fonction_lettres'] ?>.</p><p>
              <?php endif; ?>
            <?php endif; ?>
              Au total, <?= $gender['pronom'] ?> a passé <?= $depute['lengthEdited'] ?> sur les bancs de l’Assemblée nationale, soit <?= $history_edito; ?> des députés, qui est de <?= $history_average['length'] ?> ans.
            </p>
            <?php if ($active == FALSE): ?>
              <p>
            ...
            <?php if ($politicalParty['libelle'] != ""): ?>
              <p><?= $title ?> est rattaché financièrement au parti politique <b><?= $politicalParty['libelle'] ?></b> (<?= $politicalParty['libelleAbrev'] ?>). Le rattachement permet aux partis politiques de recevoir, pour chaque député, une subvention publique.</p>
            <?php endif; ?>
          ...
          <div class="bloc-links p-lg-0 p-md-2 mt-5">
            ...
            <div class="row mt-4">
              <div class="col-12 col-sm-6 mt-2 d-flex justify-content-center">
                <a href="http://www2.assemblee-nationale.fr/deputes/fiche/OMC_<?= $depute['mpId']; ?>" target="_blank" rel="noopener" role="button" class="btn btn-an d-flex align-items-center justify-content-center">
                  Profil Assemblée Nationale
                </a>
              </div>
              <?php if ($depute['website'] !== NULL): ?>
                <div class="col-12 col-sm-6 mt-2 d-flex justify-content-center">
                  <a href="https://<?= $depute['website'] ?>" target="_blank" rel="noopener" role="button" class="btn btn-website d-flex align-items-center justify-content-center">
              ...
              <?php if ($depute['facebook'] !== NULL): ?>
                <div class="col-12 col-sm-6 mt-2 d-flex justify-content-center">
                  <a href="https://www.facebook.com/<?= $depute['facebook'] ?>" target="_blank" rel="noopener" role="button" class="btn btn-fcb d-flex align-items-center justify-content-center">
                    <?php echo file_get_contents(base_url().'/assets/imgs/logos/facebook_svg.svg') ?>
                    <span class="ml-3">Son profil Facebook</span>
                  </a>
                </div>
              <?php endif; ?>
              <?php if ($depute['twitter'] !== NULL): ?>
                <div class="col-12 col-sm-6 mt-2 d-flex justify-content-center">
                  <a href="https://twitter.com/<?= $depute['twitter']; ?>" target="_blank" rel="noopener" role="button" class="btn btn-twitter d-flex align-items-center justify-content-center">
                    <?php echo file_get_contents(base_url().'/assets/imgs/logos/twitter_svg.svg') ?>
                    <span class="ml-3">Son profil Twitter</span>
                  </a>
                </div>
              <?php endif; ?>
            </div>
