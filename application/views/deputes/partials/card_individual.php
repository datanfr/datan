<div class="card card-profile">
  <div class="card-body">
    ...
    <div class="bloc-bref mt-3 d-flex justify-content-center justify-content-lg-start">
      <ul>
        <li class="first">
          <div class="label"><?= file_get_contents(FCPATH . '/assets/imgs/icons/geo-alt-fill.svg') ?></div>
          <div class="value"><?= $depute['departementNom'] . ' (' . $depute['departementCode'] . ')' ?></div>
        </li>
        <?php if ($active && !$historique) : ?>
          <li>
            <div class="label"><?= file_get_contents(FCPATH . '/assets/imgs/icons/person-fill.svg') ?></div>
            <div class="value"><?= $depute['age'] ?> ans</div>
          </li>
          <?php if ($commission_parlementaire): ?>
            <li class="mb-0">
              <div class="label"><?= file_get_contents(FCPATH . '/assets/imgs/icons/briefcase-fill.svg') ?></div>
        ...
        <?php if (!$active || $historique): ?>
          <li class="mb-0">
            <div class="label"><?= file_get_contents(FCPATH . '/assets/imgs/icons/calendar-date-fill.svg') ?></div>
