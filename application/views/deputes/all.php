      ...
      <div class="row row-grid mt-5">
        ...
        <div class="col-md-3 offset-md-1">
          ...
          <div class="d-flex flex-wrap">
            <?php if ($legislature != legislature_current()): ?>
              <a href="<?= base_url() ?>deputes" class="btn btn-secondary my-2">16<sup>ème</sup> législature</a>
            <?php endif; ?>
            ...
            <?php foreach ($deputes as $depute): ?>
              <div class="col-md-6 col-xl-4 sorting-item <?= strtolower($depute["libelleAbrev"]) ?>">
                <div class="d-flex justify-content-center">
                  <?php $this->load->view('deputes/partials/card_home.php', array('depute' => $depute, 'tag' => 'h3', 'footer' => 'group', 'logo' => false)) ?>
                </div>
              </div>
            <?php endforeach; ?>
          </div>
