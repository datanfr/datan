      ...
      <div class="row">
        <div class="col-lg-3 col-md-4 pt-md-5 pt-3 bloc-infos" style="background-color: #e9e9e9; color: black!important">
          ...
          <?php if (!empty($ville["population"])): ?>
            <p><?= $ville["commune_nom"] ?> compte <b><?= $ville["population_format"] ?> habitants</b>. La population de la commune a <b><?= $ville['evol10_text'] ?></b> de <?= round($ville['evol10_edited']) ?>% depuis 10 ans.</p>
          <?php endif; ?>
          ...
          <?php else: ?>
            <?php if ($n_circos == 1): ?>
              <div class="d-flex justify-content-center">
                <?php $this->load->view('deputes/partials/card_home.php', array('depute' => $depute_commune, 'tag' => 'h2', 'footer' => 'discover', 'logo' => true)) ?>
              </div>
            <?php else: ?>
        ...
        <div class="container">
          ...
          <div class="row mt-3">
            <div class="<?= $n_circos == 1 ? 'col-lg-7' : 'col-lg-8 offset-lg-2' ?> d-flex flex-column justify-content-center">
              ...
              <p>Les <a href="<?= base_url() ?>elections/legislatives-2024">dernières élections législatives</a> se sont tenues en 2024. Elles ont servi à élire <a href="<?= base_url() ?>deputes">les députés</a> qui composent l'Assemblée nationale. Ces élections ont été organisées après que le présiedent Emmanuel Macron <a href="https://datan.fr/blog/actualite-politique/le-president-emmanuel-macron-annonce-la-dissolution-de-lassemblee-nationale" target="_blank">ait décidé de dissoudre l'Assemblée</a>.</p>
              ...
              <?php foreach ($results_legislatives_last as $key => $value): ?>
                <div class="card mx-1 my-4">
                  <div class="card-body pb-0">
                    <h3>Élections législatives 2024</h3>
                    <span class="round">
        ...
        <div class="row mt-4">
          ...
          <div class="col-12 py-4 d-flex flex-wrap justify-content-around">
            <?php foreach ($deputes_dpt as $depute): ?>
              <?php $this->load->view('deputes/partials/card_home.php', array('depute' => $depute, 'tag' => 'h3', 'footer' => 'discover', 'logo' => true)) ?>
            <?php endforeach; ?>
          </div>
