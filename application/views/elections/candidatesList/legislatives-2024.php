<div class="row mt-5 mb-3">
  ...
  <div class="col-lg-9 mt-3">
    <p>Notre équipe a répertorié <?= $candidatsN ?> député<?= $candidatsN > 1 ? 's' : '' ?> ou ancien<?= $candidatsN > 1 ? 's' : '' ?> député<?= $candidatsN > 1 ? 's' : '' ?> candidat<?= $candidatsN > 1 ? 's' : '' ?> aux élections législatives de 2024. Si un député n'est pas dans la liste, n'hésitez pas à nous envoyer un email : info@datan.fr</p>
  </div>
