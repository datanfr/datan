      ...
      <?php foreach ($departements as $departement): ?>
        <div class="col-6 col-md-4 py-2">
          <?php if($departement['slug'] === 'paris-75'): ?>
            <a class="membre no-decoration underline url_obf" url_obf="<?= url_obfuscation(base_url() . "elections/resultats/" .$departement['slug']. "/ville_paris") ?>" class="no-decoration underline-blue"><?= $departement['departement_nom'] ?> (<?= $departement['departement_code'] ?>)</a>
          <?php else: ?>
