<div class="mt-4" id="listesAccordion">
    <?php foreach($listes as $liste): ?>
        ...
        <div class="liste-header d-flex align-items-center px-4 py-3" data-toggle="collapse" data-target="#liste-<?= $arrondissements ? "arr-" : "" ?><?= $liste['numero_panneau'] ?>">
        ...
        <div id="liste-<?= $arrondissements ? "arr-" : "" ?><?= $liste['numero_panneau'] ?>" class="collapse">
