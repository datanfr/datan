<div class="container pg-resultats-dpt">
  ...
  <div class="row my-5">
    <div class="col-8">
      <p class="mb-0">Découvrez tous les candidats et les résultats des élections municipales 2026 <?= $dpt['libelle_1'] ?><?= $dpt['departement_nom'] ?> (<?= $dpt['region'] ?>). Le premier tour des élections municipales se tiendra le 15 mars 2026 et le second tour le 22 mars 2026.</p>
