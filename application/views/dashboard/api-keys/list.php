<div class="content-wrapper">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <p class="small text-muted">
                        <strong>Paramètres :</strong> page, per_page (max 10000), fields, sort, order
                    </p>
                    ...
                    <p class="small text-muted mb-0">
                        <strong>Paramètres :</strong> page, per_page (max 10000), fields, legislature, year, month, vote_type, sort_code, sort, order
                    </p>
                    <p class="small text-muted">
                    ...
                    <p class="small text-muted mb-0">
                        <strong>Paramètres GET :</strong> page, per_page (max 10000), fields, state (draft/published), legislature, category, sort, order
                    </p>
                    <p class="small text-muted">
    ...
    "state": "published"
                    ...
                    <p class="small text-muted mb-0">
                        <strong>Paramètres GET :</strong> page, per_page (max 10000), fields, legislature, status (pending/done/all), sort, order
                    </p>
                    <p class="small text-muted">
