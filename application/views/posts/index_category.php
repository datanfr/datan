          ...
          <div class="row no-gutters">
            ...
            <div class="col">
              <div class="card-block p-3">
                ...
                <h2 class="card-title">
                  <a href="<?= base_url() ?>blog/<?= $post['category_slug'] ?>/<?= $post['slug'] ?>" class="stretched-link"><?= $post['title'] ?></a>
                </h2>
    ...
    <div class="col-md-3">
      ...
      <div class="card card-right-posts mt-3 card-social-media-posts">
        ...
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item">
            <a href="https://twitter.com/datanFR" class="no-decoration underline" target="_blank">
