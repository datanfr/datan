        ...
        <div class="row mt-5">
          ...
          <div class="col-md-4 d-flex justify-content-center my-2">
            <span class="d-flex align-items-center url_obf btn btn-light" url_obf="<?= url_obfuscation("https://www.facebook.com/datanFR/") ?>">
              <img class="img-lazy" src="<?= asset_url() ?>imgs/placeholder/placeholder-social-media.png" data-src="<?= asset_url() ?>imgs/logos/facebook.png" alt="Logo Facebook">
          ...
          <div class="col-md-4 d-flex justify-content-center my-2">
            <span class="d-flex align-items-center url_obf btn btn-light" url_obf="<?= url_obfuscation("https://twitter.com/datanFR") ?>">
              <img class="img-lazy" src="<?= asset_url() ?>imgs/placeholder/placeholder-social-media.png" data-src="<?= asset_url() ?>imgs/logos/twitter.png" alt="Logo Twitter">
